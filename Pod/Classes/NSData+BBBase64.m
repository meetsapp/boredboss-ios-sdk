...
@implementation NSData (BBBase64)
...
//
+ (NSData *)bb_dataFromBase64String:(NSString *)aString
{
	NSData *data = [aString dataUsingEncoding:NSASCIIStringEncoding];
	size_t outputLength;
	void *outputBuffer = BB_NewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)bb_base64EncodedString
{
	...
	char *outputBuffer =
		BB_NewBase64Encode([self bytes], [self length], false, &outputLength);

...
@implementation BBSerialization

#pragma mark - Encoding/decoding utilities

+ (NSData *)JSONSerializeObject:(id)obj
{
    id coercedObj = [BBSerialization JSONSerializableObjectForObject:obj];
    NSError *error = nil;
    NSData *data = nil;
    @try {
...
{
    NSString *b64String = @"";
    NSData *data = [BBSerialization JSONSerializeObject:array];
    if (data) {
        b64String = [data bb_base64EncodedString];
